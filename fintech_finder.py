...
balance_in_ether = get_balance(w3,account.address)
st.write(balance_in_ether)
...
wage = hourly_rate * candidate_database[person][3]

# @TODO
# Write the `wage` calculation to the Streamlit sidebar
st.sidebar.write(f"Total wages: {wage}")
